...
public class DropRulesEvent extends LivingEvent {
    ...
    public DropRulesEvent(EntityLivingBase entity, ICuriosItemHandler handler, DamageSource source, int lootingLevel,
        boolean recentlyHit) {
        super(entity);
        this.source = source;
    ...
    /**
     * Adds an override {@link ruiseki.okcurios.api.type.capability.ICurio.DropRule} for the given
    ...
    public void addOverride(Predicate<ItemStack> predicate, DropRule dropRule) {
        overrides.add(Pair.of(predicate, dropRule));
    }
